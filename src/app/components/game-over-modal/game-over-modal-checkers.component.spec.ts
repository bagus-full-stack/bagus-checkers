...
import { GameOverModalCheckersComponent } from './game-over-modal-checkers.component';
...
describe('GameOverModalCheckersComponent', () => {
  beforeEach(() => {
    TestBed.configureTestingModule({});
  });

  function setup() {
    return TestBed.createComponent(GameOverModalCheckersComponent);
  }
